...
function Footer() {
  return (
    <div data-scroll data-scroll-speed=".1" className=" futter w-full bg-zinc-900">
      <div className="tpdv w-full h-[86vh] flex">
        <div className="lftdv w-1/2 h-full">
          <h1 className=" text-8xl font-bold font-['Founders_Grotesk'] mt-10 ml-14">
            EYE- <br />
            OPENING
          </h1>
        </div>
        <div className="rghtdv w-1/2 h-full overflow-hidden">
          <h1 className=" text-[6vw] font-bold ">PRESENTATIONS</h1>
          <div className="flex h-[80%] w-full">
            <div className="lnks h-[100%] w-1/2">
              ...
              <div className=" gap-3 mt-10 flex flex-col">
                  L:
                <ul>
                  <li>
            ...
            <div className="lnks h-[100%] w-1/2">
            <div className=" ml-36 mt-52 gap-3 w-fit flex flex-col">
                  L:
                <ul>
                  <li><a href="#">Home</a></li>
      ...
      <div className="btmdv w-full h-16 flex items-center justify-between px-10">
      ...
      <div className="links ">
          <ul className="w-[40vw] flex justify-between text-zinc-500">
               <li>© ochi design 2024. <a href="#" className=" underline underline-offset-4">Legal Terms</a></li>
               <li><a href="#">Website by Obys</a></li>
          </ul>
      </div>
      </div>
    </div>
